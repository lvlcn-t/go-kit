# go-kit/lists - Env Module<!-- omit from toc -->
...
This module complements the [`os`](https://pkg.go.dev/os) module of the standard library by providing additional functionality like environment variable parsing and default value handling.
...
The documentation for this module can be found on [pkg.go.dev](https://pkg.go.dev/github.com/lvlcn-t/go-kit/env).

To see how to use this module, you can check the [examples](../example/env) directory of the [repository](https://github.com/lvlcn-t/go-kit).
