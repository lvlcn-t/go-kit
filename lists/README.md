# go-kit/lists - Lists Module<!-- omit from toc -->

<!-- markdownlint-disable MD033 -->
<p align="center">
    <a href="https://pkg.go.dev/github.com/lvlcn-t/go-kit"><img alt="Go Reference" src="https://pkg.go.dev/badge/github.com/lvlcn-t/go-kit/lists.svg"></a>
...
The `lists` module provides a set of tools to manage slices in Go.

## About this module

This module complements the [`slices`](https://pkg.go.dev/slices) module of the standard library by providing additional functionality like slice filtering and manipulation.
...
```bash
go get github.com/lvlcn-t/go-kit/lists
```

And import the package in your code:

```go
import "github.com/lvlcn-t/go-kit/lists"
```

## Usage

The documentation for this module can be found on [pkg.go.dev](https://pkg.go.dev/github.com/lvlcn-t/go-kit/lists).

To see how to use this module, you can check the [examples](../example/lists) directory of the [repository](https://github.com/lvlcn-t/go-kit).
