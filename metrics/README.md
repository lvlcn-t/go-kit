# go-kit/metrics - Metrics Module<!-- omit from toc -->

<!-- markdownlint-disable MD033 -->
<p align="center">
    <a href="https://pkg.go.dev/github.com/lvlcn-t/go-kit"><img alt="Go Reference" src="https://pkg.go.dev/badge/github.com/lvlcn-t/go-kit/metrics.svg"></a>
...
This module provides two wrappers around [OpenTelemetry](https://opentelemetry.io/) and [Prometheus](https://prometheus.io/) to initialize a trace provider and a prometheus registry.
...
The documentation for this module can be found on [pkg.go.dev](https://pkg.go.dev/github.com/lvlcn-t/go-kit/metrics).

To see how to use this module, you can check the [examples](../example/metrics) directory of the [repository](https://github.com/lvlcn-t/go-kit).
